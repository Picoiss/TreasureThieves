...
public class GameManager {
    ...
    public GameManager(Consumer<GameManager> setupScreenLauncher,
        ...
        Tower bronzeArcher = new Tower("Bronze Archer", 5, 100, "Bronze", 100);
        Tower bronzeDwarf = new Tower("Bronze Dwarf", 7, 125, "Bronze", 125);
        Tower bronzeVillager = new Tower("Bronze Villager", 7, 150, "Bronze", 150);
        Tower silverKnight = new Tower("Silver Knight", 2, 150, "Silver", 150);
        Tower silverPriest = new Tower("Silver Priest", 2, 170, "Silver", 170);
        Tower silverAlchemist = new Tower("Silver Alchemist", 1, 190, "Silver", 190);
